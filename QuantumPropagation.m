function [J]=QuantumPropagation(H_mat,k,n,q,gammain,Lin2,Ldep,Lout,psi)
...
%         VonNeuman=-1i*(lem(H_mat,l)-rim(H_mat,l));%commutation of H and rho%
...
%         rho_vector=null(full(L));  %more acurate but slower kernel calculation
        ...
        % current calculation: % notice it's a shortcut. whenever you have time, base it on lindblad
